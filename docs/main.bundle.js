...
var app_routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_1__components_index_paginas__["c" /* PortafolioComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__item_item_component__ = __webpack_require__("../../../../../src/app/components/item/item.component.ts");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__item_item_component__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_2__portafolio_portafolio_component__["a"]; });
...
//Incluimos todas las paginas que son rutas
...
module.exports = "<section class=\"ae-container-fluid rk-main animated fadeIn\">\n  <section class=\"ae-container-fluid ae-container-fluid--inner rk-portfolio animated fadeIn\">\n\n    <!--  Loader -->\n\n    <div align=\"center\" *ngIf=\"_ps.cargando\">\n\n      <h4>Cargando...</h4>\n      <div class=\"loader loader--style1\" title=\"0\" align=\"center\">\n        <svg version=\"1.1\" id=\"loader-1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"\n        width=\"40px\" height=\"40px\" viewBox=\"0 0 40 40\" enable-background=\"new 0 0 40 40\" xml:space=\"preserve\">\n        <path opacity=\"0.2\" fill=\"#000\" d=\"M20.201,5.169c-8.254,0-14.946,6.692-14.946,14.946c0,8.255,6.692,14.946,14.946,14.946\n        s14.946-6.691,14.946-14.946C35.146,11.861,28.455,5.169,20.201,5.169z M20.201,31.749c-6.425,0-11.634-5.208-11.634-11.634\n        c0-6.425,5.209-11.634,11.634-11.634c6.425,0,11.633,5.209,11.633,11.634C31.834,26.541,26.626,31.749,20.201,31.749z\"/>\n        <path fill=\"#000\" d=\"M26.013,10.047l1.654-2.866c-2.198-1.272-4.743-2.012-7.466-2.012h0v3.312h0\n        C22.32,8.481,24.301,9.057,26.013,10.047z\">\n        <animateTransform attributeType=\"xml\"\n        attributeName=\"transform\"\n        type=\"rotate\"\n        from=\"0 20 20\"\n        to=\"360 20 20\"\n        dur=\"0.5s\"\n        repeatCount=\"indefinite\"/>\n      </path>\n    </svg>\n  </div>\n      <p><span>Espere por favor...</span></p>\n\n    </div>\n\n\n    <div\n      *ngIf=\"_ps.productos_filtrados.length > 0 && !cargando\"\n      class=\"ae-masonry ae-masonry-md-2 ae-masonry-xl-4 animated fadeIn\">\n      <a\n        *ngFor=\"let producto of _ps.productos_filtrados\"\n        [routerLink]=\"['/item',producto.cod]\"\n        class=\"rk-item ae-masonry__item animated fadeIn\">\n        <img src=\"assets/productos/{{producto.url}}\" alt=\"\">\n        <div class=\"item-meta\">\n          <h2>{{ producto.titulo }}</h2>\n          <p>{{ producto.categoria }}</p>\n        </div>\n      </a>\n    </div>\n  </section>\n</section>\n"
...
var InformacionService = (function () {
    ...
    InformacionService.prototype.carga_sobre_nosotros = function () {
        var _this = this;
        this.http.get("https://webpage-57d88.firebaseio.com/equipo.json")
            .subscribe(function (data) {
            //console.log(data);
            //console.log(data.json());
...
var ProductosService = (function () {
    ...
    ProductosService.prototype.cargar_productos = function () {
        ...
        var promesa = new Promise(function (resolve, reject) {
            _this.http.get('https://webpage-57d88.firebaseio.com/productos_idx.json')
                .subscribe(function (res) {
